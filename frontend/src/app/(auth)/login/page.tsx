            ...
            <div className="mt-6 p-3 bg-zinc-800/50 rounded-lg border border-zinc-700/50">
              ...
              <div className="space-y-1.5 text-xs text-zinc-400">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => { setValue('email', 'owner@demo.com'); setValue('password', 'Demo@2024!'); }}
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => { setValue('email', 'manager@demo.com'); setValue('password', 'Demo@2024!'); }}
                    className="text-zinc-300 hover:text-blue-400 transition-colors truncate text-right"
                  >
                    manager@demo.com
                  </button>
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => { setValue('email', 'staff@demo.com'); setValue('password', 'Demo@2024!'); }}
                    className="text-zinc-300 hover:text-blue-400 transition-colors truncate text-right"
                  >
                    staff@demo.com
                  </button>
